<template>
  <ActivityHeader
    ...
    :custom-start-time="ticket?.custom_start_time || ''"
    :custom-end-time="ticket?.custom_end_time || ''"
  />
...
const props = defineProps({
  ...
  ticketName: {            // ✅ FIXED: proper object syntax
    type: String,
    default: "",
  },
});
...
function scrollToLatestActivity() {
  setTimeout(() => {
    ...
    if (el && !isElementInViewport(el)) {
      ...
      // Optional: support old Chrome, but guarded
