...
permission_query_conditions = {
    "Payment Collection Task": "test_app.api.permission.get_permission_query_conditions",
}

has_permission = {
    "Payment Collection Task": "test_app.api.permission.has_permission",
}
